...
<div class="masthead"><img src="./silica_icon_small.png" alt="Silica" width="68" height="68"><span class="masthead-tagline">Memory-safe, functional systems language — secure by default at compile time</span></div>
