// runtime_asm/linux_aarch64/silica_rt_shim.s - Linux (glibc, AArch64) build of ../../silica_rt_shim.s:
// same code with ELF symbol names (no leading underscore), .rodata, and :lo12: relocations.
//
...
silica_append_file_path:
    ...
    mov  x19, x0
    mov  x0, x19
    adrp x1, Lmode_append
    add  x1, x1, :lo12:Lmode_append
    bl   fopen
