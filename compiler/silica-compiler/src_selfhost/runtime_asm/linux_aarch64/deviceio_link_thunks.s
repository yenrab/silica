// runtime_asm/linux_aarch64/deviceio_link_thunks.s - Linux (glibc, AArch64) build of
// ../../deviceio_link_thunks.s: ELF symbol names and the Linux mmap syscall (222, MAP_PRIVATE|MAP_ANONYMOUS = 0x22, -errno on failure).
.text
.p2align 2
