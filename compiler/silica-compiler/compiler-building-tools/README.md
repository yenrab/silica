...
| **Planning and integration**      | `silica-compiler-phase-planning-tool` (phase design and coordination), `silica-CI` (driving CI-style checks), `golden-fail-generator` (golden / failure test workflows around trial outputs), `silica-module-checker-debug-tool` (spec- and source-grounded debugging for the module checking phase).                                                                                          |
